...
# Time constraints
con1 = {} #New: Arrival time should be later than ready time
con2 = {} #New: Arrival time should not be later than due time
con3 = {} #New: Ensures that arrival time of vehicle k at j is equal to the sum of the arrival time at i, the sT and rT. 
for i in N:
    for k in K:
...
con9 = {} #New: Allows vehicles to serve nodes transited.
for j in range(1,len(N)):
