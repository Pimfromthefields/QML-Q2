...
#num_vehicle = 8
#c = [20,20,20,20,20,20,100,100]
#fc = [100,100,100,100,100,100,4000,4000]
...
# ---- Objective Function ----
model.setObjective (quicksum(d[i,j] * x[i,j,k] for i in N for j in N for k in K) + quicksum(fc[k]*x[0,j,k] for j in range(1,len(N)) for k in K))
